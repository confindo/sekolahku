...
@section('optionalHeader')
    <link rel="stylesheet" type="text/css" href="{{ url('schoolAssets/css') }}/{{ $data->css }}">
...
@section('topTopic')
    <div class="container-fluid" id="topTopic">
        <div class="row">
            ...
            <div class="col-md-2">
                <img src="{{ url('schoolAssets/images') }}/{{ $data->schoolLogo }}" class="img-responsive" id="schoolLogo">
            </div>
            ...
            <div class="col-md-1">
                <img src="{{ url('schoolAssets/images') }}/{{ $data->optImage }}" class="img-responsive" id="ribbonLogo">
            </div>
        </div>
    </div>
